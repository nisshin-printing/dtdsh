	...
	class VK_Custom_Field_Builder {
		...
		*/
		public static function print_script() {
			wp_register_script( 'datepicker', get_template_directory_uri() . '/assets/js/datepicker.js', array( 'jquery', 'jquery-ui-datepicker' ), self::$version, true );
			wp_enqueue_script( 'datepicker' );
			wp_register_script( 'vk_mediauploader', get_template_directory_uri() . '/assets/js/mediauploader.js', array( 'jquery' ), self::$version, true );
			wp_enqueue_script( 'vk_mediauploader' );
			wp_enqueue_style( 'cf-builder-style', get_template_directory_uri() . '/assets/css/cf-builder.css', array(), self::$version, 'all' );
		}
