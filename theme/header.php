		...
		<div class="o-row">
			...
			<?php
				...
				if ( is_front_page() ) {
					...
					$header_desc = '<p>※クライアントの売上・規模・検索順位（「広島　○○」というキーワード）・市場シェア率・それらの維持年月などからクライアント自体が広島トップクラスです。（最長継続契約年数15年以上）（以下、※印省略）</p>';
				} elseif ( is_page( 'service/marketing-automation' ) ) {
					$header_copy = 'WordPressのようなオープンソースだから<br>安くて高機能なマーケティングオートメーション';
				} elseif ( is_page( 'service/balance-design' ) ) {
					$header_copy = '<span style="font-family:\'Poiret One\'">Balance Design</span>';
					$header_desc = '<p>手芸/編み物などハンドメイドが趣味の社員を日進印刷のマーケターが全力サポート。<br>販売経験がなかったので、流行/競合調査により新作デザインの提案、実店舗やオンラインストアの価格帯も同時に調査し価格の提案をしました。</p><p>その結果、販売開始後2週間で注文が殺到し、2週間後には200人ものお客様へ雑貨をお届けしました。クリエイターに販売経験なし・広告なし・販促活動なしという製作費以外発生していない上で<strong class="u-underline">異例の快挙</strong>をあげました。</p>';
