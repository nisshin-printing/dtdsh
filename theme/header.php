	...
	<header class="c-header-main" id="js-header-main">
		...
		<?php
			...
			if ( is_front_page() ) {
				...
				$header_desc = '<p>※クライアントの売上・規模・検索順位（「広島　○○」というキーワード）・市場シェア率・それらの維持年月などからクライアント自体が広島トップクラスです。そしてそれを支える日進印刷のWebコンサルティングもクライアントが広島No.1である比率が広島No.1です。（2017年6月現在100%。最長継続契約年数10年以上）（以下、※印省略）</p>';
